...
class AlarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post alarms_url, params: { alarm: { content: @alarm.content, user_id: @alarm.user_id } }
    end
  ...
  test "should update alarm" do
    patch alarm_url(@alarm), params: { alarm: { content: @alarm.content, user_id: @alarm.user_id } }
